...
loader.load(
  ...
  function (gltf) {
      ...
      <div class="terminal-window">
        <div class="terminal-output" id="terminalOutput">
          <div class="terminal-line">
            <span class="help-msg">Welcome to my portfolio! — Type <span class="code">help</span> for a test list of supported commands.</span>
          </div>
        </div>
        <div class="terminal-line">
    ...
    terminalObject.position.set(0, 6.2, 9);
